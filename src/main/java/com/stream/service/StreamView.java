...
public class StreamView {
	...
	public String stream(String video_name, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		// 확장자 체크
		...
		// // 확장자 에러 //
		// String resultMsg = new MessageMaker()
		// .getErrorMessage("Wrong file name. You need to include expand file name");
		...
		String pathname = movieDir + "\\" + video_name;
